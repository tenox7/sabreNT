...
public:
  ...
  virtual void put_char(unsigned char c, int x, int y, int color,
								unsigned char *buffer_ptr, int dim = 0) = 0;
  void put_char(unsigned char c, int x, int y, int color, int opt = 0);
  void put_string(char *str, int x, int y, int color);
  void __cdecl font_sprintf(int x, int y, int color, int opt, char *format, ...);
};
...
public:
  ...
  Font8x8(char *);
  virtual void put_char(unsigned char c, int x, int y, int color,
								unsigned char *buffer_ptr, int dim = 0);
  };
