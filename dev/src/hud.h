...
public:
  ...
  void do_hud_formation_geometry(const aiTargetGeometry &, Port_3D &);
  void do_hud_target_geometry(const aiTargetGeometry &, Port_3D &);
  void do_hud_target_flags(int, int, const aiTargetFlags &);
