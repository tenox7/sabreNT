...
inline istream &operator >>(istream &is, C_3DInfoManager &cm)
{
  cm.read(is);
  return(is);
}

inline ostream &operator <<(ostream &os, C_3DInfoManager &cm)
{
  cm.write(os);
  return(os);
}
...
inline istream & operator >>(istream &is, C_3DObject2 &ob)
{
  ob.read(is);
  return(is);
}

inline ostream & operator <<(ostream &os, C_3DObject2 &ob)
{
  ob.write(os);
  return(os);
}
