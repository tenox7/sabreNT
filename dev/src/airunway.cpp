...
aiRunway::aiRunway(const airunway_info &rwi)
{
aiPoint position;
aiAttitude attitude;

	position = aiPoint(rwi.x,rwi.y,rwi.z);
...
void aiRunway::GetLandingTurnPoint(aiPoint &turnPoint, aiREAL approachDistance, aiREAL turnRadius,
									int clockWise)
{
aiVector v0,w0;
...
void aiRunway::GetTakeoffPositionAndAttitude(aiPoint &position, aiAttitude &attitude)
{
aiVector v0,w0;
