...
aiTargetGeometry::aiTargetGeometry()
{
	angleOff = aspect = 
	range = dRange = 0.0;
...
aiTargetInfo::aiTargetInfo()
{
	...
	tacticalCaps[aiPilotTactics::ANGLES_FIGHT] = 1;
	tacticalCaps[aiPilotTactics::ENERGY_FIGHT] = 0;
	tacticalCaps[aiPilotTactics::DIVE_BOMB] = 0;
	tacticalCaps[aiPilotTactics::TORPEDO_BOMB] = 0;
	tacticalCaps[aiPilotTactics::LEVEL_BOMB] = 0;
	maxSpeed = 325.0;
	weaponsRange = 2000.0;
	weaponsEffect = 4.0;
}
...
void aiTargetFlags::Add(const aiTargetFlags &fl)
{
 ...
 */
void aiTargetFlags::Set(int max)
{
...
void aiTarget::GetTargetInfo(unsigned long targetIdx, aiPoint &position, 
										aiVector &velocity, aiVector &heading)
{
}

int aiTarget::GetTargetActive(unsigned long targetIdx)
{
	return 0;
}
