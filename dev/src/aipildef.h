...
#define TARGET_CAN_ENERGY_FIGHT	TARGET_INFO.tacticalCaps[aiPilotTactics::ENERGY_FIGHT]
#define TARGET_CAN_ANGLES_FIGHT	TARGET_INFO.tacticalCaps[aiPilotTactics::ANGLES_FIGHT]
...
#define IS_ENERGY_FIGHT				(tactics.curTactic == aiPilotTactics::ENERGY_FIGHT)
#define IS_ANGLES_FIGHT				(tactics.curTactic == aiPilotTactics::ANGLES_FIGHT)
#define IS_WEENIE_FIGHT				(tactics.curTactic == aiPilotTactics::WEENIE_FIGHT)
#define CAN_ENERGY_FIGHT			(tactics.TacticAvail(aiPilotTactics::ENERGY_FIGHT) == 1)
#define CAN_ANGLES_FIGHT			(tactics.TacticAvail(aiPilotTactics::ANGLES_FIGHT) == 1)
#define CAN_STRAFE					(tactics.TacticAvail(aiPilotTactics::STRAFE) == 1)
#define CAN_ROCKET					(tactics.TacticAvail(aiPilotTactics::ROCKET) == 1)
#define CAN_DIVE_BOMB				(tactics.TacticAvail(aiPilotTactics::DIVE_BOMB) == 1)
#define CAN_TORPEDO_BOMB			(tactics.TacticAvail(aiPilotTactics::TORPEDO_BOMB) == 1)
#define CAN_LIGHT_BOMB				(tactics.TacticAvail(aiPilotTactics::LIGHT_BOMB) == 1)
#define CAN_HEAVY_BOMB				(tactics.TacticAvail(aiPilotTactics::HEAVY_BOMB) == 1)
...
inline aiREAL ANGELS(aiPilot *pil)
{
