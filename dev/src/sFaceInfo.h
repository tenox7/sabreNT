 ...
 *************************************************/
#ifndef __sfaceinfo_h
#define __sfaceinfo_h
...
#define SHADOW       4L
// C_Poly  : do *not* backface cull me
#define NO_BACKFACE  8L
// C_Poly  : invisible
#define INVISIBLE   16L
...
// C_Shape : i've got tags
#define TAG_PRESENT  32L
...
public:
  ...
  static void set_read_tags(int sw)
  {
		read_tags = sw;
  }
