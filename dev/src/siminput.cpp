...
int FlightInput::SwitchOnKey(int key, Flight_Node &node, Flight_Manager &fm)
{
	...
	case FI_NEXT_ENEMY:
		select_next = Flight_Manager::NEXT_ENEMY;
		break;

	case FI_NEXT_FRIENDLY:
		select_next = Flight_Manager::NEXT_FRIENDLY;
		break;

	case FI_NEXT_WINGMAN:
		select_next = Flight_Manager::NEXT_WINGMAN;
		break;

	case FI_NEXT_ANY:
		select_next = Flight_Manager::NEXT_ANY;
		break;
